...
const Flex = () => {
  return (
    <div className="flex flex-wrap mt-8 lg:flex-row  justify-center  items-center lg:max-w">
      ...
      <div className="box   md:bg-zinc-300 lg:bg-stone-700 bg-yellow-500 h-32 w-32 p-4 border-4 text-center flex items-center justify-center lg:items-center">
        02
      </div>
